...
router.get("/renter/:tenantId", verifyToken, (req, res, next) => {
    console.log("GET /contracts/renter/:tenantId", req.params);
    next();
}, getContractsForRenter);
...
router.get('/', verifyToken, (req, res, next) => {
    console.log("GET /contracts - Lấy tất cả hợp đồng");
    next();
}, getAllContracts);

// Tạo hợp đồng mới (yêu cầu xác thực)
router.post('/create', verifyToken, (req, res, next) => {
    console.log("POST /contracts/create - Body:", req.body);
    next();
}, createContract);
